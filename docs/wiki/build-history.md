# Build History - completed-milestone narratives

Updated: 2026-08-01 (split out of [[build-progress]])

The detailed narratives behind the wave table in [[build-progress]], moved here
VERBATIM on 2026-08-01 so that entry stays a readable status ledger. Nothing
below was rewritten - dated sections read exactly as they did when written
(annotations included). New milestone narratives are written in
[[build-progress]] first and migrate here once stable.
